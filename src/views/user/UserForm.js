...
export default function UserForm() {
  ...
  /**
   * A função 'handleSave' é invocada para salvar os dados do formulário.
    ...
    <>
      ...
      <form onSubmit={handleSave}>
        <fieldset className="form-group" disabled={submitting}>
          ...
          <input type="text" name="first_name" className="form-control" placeholder="Fulano"
        ...
        <fieldset className="form-group" disabled={submitting}>
          ...
          <input type="text" name="last_name" className="form-control" placeholder="de Tal"
        ...
        <fieldset className="form-group" disabled={submitting}>
          <label>E-mail</label>
          <input type="email" name="email" className="form-control" placeholder="fulano@gmail.com"
        ...
        <div className="mt-2">
          ...
          <button className="btn btn-light" style={{ minWidth: '100px' }} 
            onClick={() => nav('/user')} disabled={submitting}>
